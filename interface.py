...
class Convergence(object):
    ...
    def _set_grids(self, grids):
        ...
        sorted_grids = sorted(pre_sort, key=lambda grid: grid[0], reverse=True)
    ...
    def _get_shared(self):
        ...
        for trip in self._grid_triplets:
            ...
            ratio_21 = float(trip[0][1] / trip[1][1])
            ratio_32 = float(trip[1][1] / trip[2][1])
...
def main(in_path, out_path, analytical=None):
    ...
    # Read in the file and create a list with grid sizes and values
